...
テクノロジーの社会的影響を対話で評価するインパクトアセスメントツール。大阪大学ELSIセンターが開発した"Moral IT-Deck"日本語版を基に、カードデッキを高校情報科向けに改変し、ワークショップ進行用スクリプトを新規開発。RRI（責任ある研究・イノベーション）の4次元（先見性・省察性・包摂性・応答可能性）を育成し、テクノロジーの倫理的課題への対峙を支援。カードデッキ、進行スクリプトを含む。CC BY-NC-SA 4.0ライセンス。
